...
export const formatToken = async ({
  ...
  return {
    ...
    logoURI: `https://mljmnqnfdxzrsriincip.supabase.co/storage/v1/object/public/token-images/${token?.address.toLowerCase()}.png`, // TODO: we need images still, maybe we can get the from FTMscan or covalent
