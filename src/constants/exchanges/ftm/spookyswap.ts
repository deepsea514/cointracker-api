...
import { TokenExtendedSpiritFragment } from '../../fragments/Token'
import { TransactionFragment } from '../../fragments/Transaction'

export const SPOOKY_SWAP_CONFIG = {
  URL: 'https://api.thegraph.com/subgraphs/name/eerieeight/spooky-swap-exchange',
  CLIENT: new GraphQLClient('https://api.thegraph.com/subgraphs/name/eerieeight/spooky-swap-exchange'),
  QUERIES: {
    PAIRS: gql`
    ...
    FACTORY: gql`
      query UniswapFactories {
        spooky: uniswapFactories(first: 1) {
          id
